def model_snippet():
    ...
    prop_motor_kind = create_clabject_prop(n="motor_kind", t=0, f='*', i_f=True, c=[], v="endurance")
    EnduranceExercise.define_props([prop_motor_kind])

    def define_energy_supply(clabject, prop_value):
        prop_energy_supply = create_clabject_prop(n="endurance_scope", t=0, f='*', i_f=True, c=[], v=prop_value)
